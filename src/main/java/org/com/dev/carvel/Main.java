...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(mapper.map(int.class));
        System.out.println(mapper.map(String.class));
        System.out.println(mapper.map(long.class));
        System.out.println(mapper.map(boolean.class));
        System.out.println(mapper.map(double.class));
    }
}